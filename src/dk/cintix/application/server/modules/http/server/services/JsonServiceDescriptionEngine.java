...
import dk.cintix.application.server.infrastructure.annotations.CacheByStatus;
...
import dk.cintix.application.server.infrastructure.annotations.Static;
import dk.cintix.application.server.modules.http.server.services.jsd.models.ArgumentDefinition;
import dk.cintix.application.server.modules.http.server.services.jsd.models.Cache;
import dk.cintix.application.server.modules.http.server.services.jsd.models.ModelDefinition;
import dk.cintix.application.server.modules.http.server.services.jsd.models.Service;
import dk.cintix.application.server.modules.http.server.services.jsd.models.ServiceAction;
        ...
        for (Method methodOrginal : methods) {
            ...
            if (method.getAnnotation(Action.class) != null) {
                ...
                if (method.getAnnotation(CacheByStatus.class) != null) {
                    dk.cintix.application.server.infrastructure.annotations.Cache[] caches = method.getAnnotation(CacheByStatus.class).value();
                    for (dk.cintix.application.server.infrastructure.annotations.Cache cache : caches) {
